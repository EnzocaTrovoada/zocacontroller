...
(function (global) {
  ...
  var SCHEMA = {
    ...
    atfollow: { t: 't', d: '{quem} seguiu!', max: 80 },
    atsub:    { t: 't', d: '{quem} assinou!', max: 80 },
    atpres:   { t: 't', d: '{quem} presenteou {quanto} subs!', max: 80 },
    atbits:   { t: 't', d: '{quem} mandou {quanto} bits!', max: 80 },
    atreal:   { t: 't', d: '{quem} doou R$ {quanto}!', max: 80 },
    atraid:   { t: 't', d: '{quem} chegou com {quanto}!', max: 80 },
    atempo:   { t: 'n', d: 6, min: 2, max: 30 },
    aentre:   { t: 'e', d: 'descer', v: ['descer', 'zoom', 'surgir', 'lado'] },
    anome:    { t: 'c', d: '#7CE07C' },
    asom:     { t: 'e', d: 'sino', v: ['nenhum', 'sino', 'moeda', 'fanfarra', 'sopro', 'proprio'] },
    /* Qual dos sons que a pessoa mandou. Zero = nenhum escolhido ainda. */
    asomid:   { t: 'n', d: 0, min: 0, max: 99999999 },
    ...
    mborrar:  { t: 'n', d: 34, min: 0,  max: 80 },
    msatura:  { t: 'n', d: 170, min: 100, max: 300 },
    mcapraio: { t: 'n', d: 14, min: 0,  max: 80 },
    mescuro:  { t: 'n', d: 22, min: 0,  max: 90 },
    mfcor:    { t: 'c', d: '#0b0f0d' },
    mfopac:   { t: 'n', d: 70,  min: 0,  max: 100 },
    mfpad:    { t: 'n', d: 12,  min: 0,  max: 40 },
